...
output_dir=/pscratch/sd/t/timothys/p2p/dlwsltghSP/inference/validation
...
do
    ...
    if [[ ${dataset} == "replay" ]] ; then
        ...
        by_init="True"
        rename_geopotential='{"hydrostatic_geopotential":"geopotential"}'
    fi
    ...
    do
        ...
        python ${wb2_dir}/scripts/evaluate.py \
          ...
          --levels=${levels} \
          --skipna=True \
          --rename_variables=$rename_geopotential
