...
def get_forcings(emulator, last_ic_datetime, lead_times):
    """
...
def predict(
    ...
    ic1 = xr.open_zarr(f"{emulator.local_store_path}/singleobs-perturbation/inputs.{prefix}.zarr")
    ...
    pname = f"{emulator.local_store_path}/singleobs-perturbation/inference.{prefix}.zarr"
...
def run_perturbation(Emulator):
    ...
    # read the common IC
    ic0 = xr.open_zarr(f"{emulator.local_store_path}/singleobs-perturbation/inputs.common.zarr")
