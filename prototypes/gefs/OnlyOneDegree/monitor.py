...
_project = "gefs"
_subproject = "OnlyOneDegree"

if __name__ == "__main__":

    for stage in ["forecast", "deviation"]:

        ds = xr.load_dataset(f"/pscratch/sd/t/timothys/graph-ufs/{_project}/{_subproject}/{stage}-training/loss.nc")
        ...
        if not os.path.isdir(fig_dir):
            os.makedirs(fig_dir)
        fig.savefig(f"{fig_dir}/training_loss_{stage}.pdf")
